...
import { ScanBarcode, ClipboardList, GitCompare, Trash2, AlertTriangle } from "lucide-react";
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-md mx-auto" style={{ background: "hsl(var(--background))" }}>
      ...
      {/* ── Header ── */}
      <header style={{ background: "hsl(var(--primary))", padding: "20px 20px 28px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ padding: "8px 16px 24px" }}>
        <div style={{
          background: "#fff", borderRadius: 16, border: "1px solid hsl(var(--border))",
