...
-- #######################################################################
-- 036 - API de pedidos do catalogo -> fila de conferencia
-- #######################################################################
...
-- ---------------------------------------------------------------------
-- 038 - Numeracao sequencial por pessoa + status realtime por item
-- ---------------------------------------------------------------------
alter table public.pedidos
...
where table_schema = 'public'
  and table_name in ('usuarios','compras','compras_erp_sync_locks',
                      'pedidos','pedido_itens','relatorios_diarios','produtos','pedido_sequencias')
order by table_name;
-- Esperado: 8 linhas (as 8 tabelas acima).
